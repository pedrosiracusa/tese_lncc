...
In fact, we consider this is the 6th mass extinction. %Wake2008
Among the main threats to biodiversity, climate change, invasive species and land use (habitat loss).
%
Several factors are relevant for assessing the conservation status of a species, including those related to the sizes and dynamics of its populations, the known major threats, and geographical distribution. % check IUCN criteria
