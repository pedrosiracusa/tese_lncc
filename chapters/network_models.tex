...
Species-collectors networks describe relationships of type ``\textbf{collector} samples \textbf{species}'' or, conversely, ``\textbf{species} is sampled by \textbf{collector}''. Whenever a collector records an individual from a given species, a link between the collector and the species is either created or strengthened.
