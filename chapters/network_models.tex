...
As most algorithms and metrics in literature are primarily designed for one-mode graphs, it is often convenient to summarize a bipartite graph by deriving direct relationships between vertices from the same set.
...
Projections, however, come with a tradeoff.
\textit{Projections} are one way to summarize bipartite graphs, by compressing  
% Bipartite projection
