...
An alternative way to represent sparse networks is to use the \texti{adjacency list} representation, which in short consists of storing a list of neighbors for every single vertex in the network. 
