...
Collector bias refers to the fact that not all collectors contribute to the same extent with specimens records to the biological collection.
Collector bias is the phenomenon in which a small subset of collectors is responsible for the majority of records.
This has been observed by \cite{Daru2017}.
