...
\ped{Devo construir esta tabela? Com bibliotecas usadas e uma breve descrição}
...
% TODO Figure team sizes frequency
% TODO Table degree (sorted by Kw) --> ColName | k | kw (considering team size (hyperbolic weighting) | num_recs 
...
%
One important example of a singleton collector is `\textit{leite,alta}', with a total of $2757$ records, none of which collaborative.  % of records from all singleton collectors
...
% What is the degree of these nodes? Where are these collectors from? It is unlikely that novice collectors would record alone, without a supervisor. If these are low-degree nodes they are probably experienced foreign collectors, who have low degrees because they've only contributed to the herbarium with few records (as exchanges).

\paragraph*{Sizes of collectors teams.}
% TODO FIGURE: team size frequency
% Only one record with team size of $9$.
% Strings are truncated for collectors field with $8$ collectors or more.
% There is apparently a constraint preventing teams with more than $9$ collectors. Maybe this is due to restrictions on the system used for entering data, which does not accept more than $9$ collectors for a record.
...
\begin{table}[H]
  ...
  \begin{tabular}{l r r r r}
      collector & num of records & $k$ & num of collaborative records & $k_w^{hyperb}$ \\
      \hline
        proenca,ceb & 4803 & 0.88 & 218 & 4203.67 \\
        faria,jeq & 4687 & 0.83 & 117 & 3881.00 \\
        ratter,ja & 4728 & 0.26 & 111 & 1084.92 \\
        munhoz,cbr & 3191 & 0.83 & 109 & 2493.17 \\
        silva,ma & 823 & 0.57 & 93 & 403.60 \\
        oliveira,rc & 723 & 0.89 & 92 & 595.25 \\
        harley,rm & 2564 & 0.66 & 90 & 1455.83 \\
        mendes,vc & 1696 & 1.00 & 89 & 1695.00 \\
        souza,vc & 505 & 0.56 & 89 & 237.62 \\
        carvalho,avm & 884 & 0.75 & 88 & 651.50 \\
        walter,bmt & 709 & 0.51 & 80 & 296.08 \\
        mendonca,rc & 1162 & 0.54 & 76 & 603.75 \\
        franca,f & 538 & 0.74 & 72 & 389.67 \\
        melo,e & 682 & 0.60 & 65 & 378.67 \\
        martins,rc & 715 & 0.93 & 63 & 664.00 \\
        silva,gp & 266 & 0.40 & 61 & 71.80 \\
        giulietti,aml & 134 & 0.69 & 60 & 70.08 \\
        cardoso,es & 385 & 1.00 & 59 & 382.75 \\
        carvalhosilva,m & 1635 & 0.98 & 58 & 1436.00 \\
        santana,sc & 88 & 0.89 & 57 & 77.00 \\
      \hline
  \end{tabular}
  \label{table:ub_cwn_}
  \end{center}
...
% TODO: REWRITE!! Remember that k_w using count attribute does not give the absolute number of collaborative records!
