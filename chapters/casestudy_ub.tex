...
The resulting network had a total of $6768$ collectors, $15344$ species nodes and $142647$ edges connecting species to collectors.
...
\paragraph*{Species and collectors degrees distribution.}
The whole network, including the giant and all the isolated components, is majoritarily composed by very low degree nodes, holding very few ties with others. There are few ones, however, which happen to be much more intensely connected than the others \ref{fig:ub_scn_degree_dist}, and are thus known as hubs.
In fact a total of $12123$ species, comprising $79\%$ of all species nodes, are linked to $10$ or fewer collectors, while conversely around $79\%$ of all collectors (a total of $5362$ nodes) are linked to $10$ or fewer species. 
...
\paragraph*{Average species per collector.}
...
\paragraph*{Average collectors per species.}
