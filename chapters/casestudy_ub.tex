...
% Although our model does not incorporate temporal dimension in its structure -> We built the frames by querying the original dataset, used to build the CWN.
