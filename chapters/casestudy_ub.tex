...
Table \ref{table:ub_collectors_florescer} lists some historically relevant collectors who have intensively contributed to the herbarium. 
\begin{table}[H]
...
\textit{amaral,ag}, \textit{eugenio,cuo} and \textit{mello,trb}.

\textit{oliveira,rc}

% pink group
\textit{camara,peas} was the first one ($1997-2003$), follwed by \textit{carvalhosilva,m}, \textit{soares,aer} ($2004-2010$) and then students ($2011-2017$). 

From $2011$ to $2017$ three communities collaborated in the context of the biodiversity project.
The name of the project was included as a node because it was included in the collectors field.
