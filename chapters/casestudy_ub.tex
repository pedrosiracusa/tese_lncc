...
%
One important example of a singleton collector is `\textit{leite,alta}', with a total of $2757$ records, none of which collaborative (Figure \ref{fig:ub_team_sizes}).  % of records from all singleton collectors
