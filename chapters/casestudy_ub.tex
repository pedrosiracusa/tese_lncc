...
The degree distribution of collectors and species are shown in Figure \ref{fig:ub_cwn_degree_dist}.
...
Approximately $76.7\%$ of all collectors nodes have degrees below or equal the average.
  ...
  \begin{figure}[h!]
    ...
    \begin{subfigure}[t]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/casestudy_ub/cwn_degree_dist_cols.pdf}
        \caption{}
        \label{fig:ub_cwn_degree_dist_cols}
    \end{subfigure}
    
    \begin{subfigure}[t]{0.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/casestudy_ub/cwn_degree_dist_spp.pdf}
        \caption{}
        \label{fig:ub_cwn_degree_dist_spp}
    \end{subfigure}
    \caption{
    \label{fig:ub_cwn_degree_dist}%
      Degree distribution for both collectors nodes $(a)$ and species nodes $(b)$ in the CWN built from records in the UB herbarium dataset. Circles represent the total number of species or collectors holding each degree value. }
  \end{figure}
