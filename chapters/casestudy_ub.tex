...
* Disjoint temporal and geographical distribution of recording activities;
* Positive or negative non-professional social relations (\textit{e.g.} friendship or rivality).
* Teams do not have the information on the collecting activities of others.
* Taxonomic resolution of the models: Teams might be interested on specific taxonomic groups at ranks that are below the resolution of our model. For instance, they might be interested in the same family, but one group interested on diversity (generalist collecting behavior) while other group is more interested towards a particular genus.

We consider the absence of coworking links between them to be an effect of lack of a social tie linking them.
%
