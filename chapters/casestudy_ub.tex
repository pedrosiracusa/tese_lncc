...
Given the very high density of our resulting network, we performed an additional filtering step before drawing the graph and identifying communities.
We use an edge filter $\phi$.
Figure \ref{fig:ub_scn_filter_threshold_projCol} shows the effect of increasing $\phi$ values on network density.
We then set $\phi = 0.8$.
