...
Some of these communities correspond to communities of interest, found in the SCN model.
%
The bryophytes research group, led by `\textit{camara,peas}' is also cohesive in terms of field expeditions.
%
Some of these communities are formed due to the activities of their collectors being temporally spaced from others in the network (as the green one, around `\textit{irwin,hs}'.
