...
As opposed to random networks, in which extremely well connected or poorly connected nodes are very unlikely to occur, the connectivity pattern observed for the UB species-collectors network resembles the one from scale-free networks, whose degree distribution $p(k)$ follows a power law described by $k^{-\alpha}$.
