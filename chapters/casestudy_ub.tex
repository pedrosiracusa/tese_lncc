...
\begin{table}[t]
  \caption{Number of distinct taxa at each taxonomic rank in the dataset. For each rank a list with its top-4 most recorded taxa is included with their respective counts.}
\begin{center}
