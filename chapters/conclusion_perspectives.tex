...
%% SCNs and CWNs should be stored in an unified structure, for example MAGs.
...
% Study of collectors carreer trajectories (Borgatti2015 on the conclusion). 
% Depends on incorporating temporal and geographic dimensions.
