...
\art{Vi que voce colocou o e.g. em italico no paragrafo anterior... para uniformizar precisa verificar ao longo de todo o texto de e.g. ou i.e. estao em italico tambem}
\ped{Estou colocando todos i.e. ou e.g. em itálico. E os números nas listas tmb}
...
\art{De forma similar com o comentario anterior, no paragrafo acime estah em italico o (i) e o (ii) da lista itemizada... tem que verificar a uniformidade disso ao longo do texto}
...
In this context, \citeonline{Wehmuth2014} have introduced the concept of \textit{Multiaspect Graphs} (MAGs) as a multilayer graph abstraction that operates on the same structure as traditional directed graphs.
...
One more possible application of our models is for recommending teams of specialists for composing biodiversity projects.
...
\citeonline{Chapman2005} have proposed that collections should incorporate in their databases an indication of the certainty of identifications, by using a system of ranks of expertise. %pg.22
