...
% Para comentários
\newcommand{\artur}[1]{\textcolor{blue}{[Artur]: #1}}
\newcommand{\luiz}[1]{\textcolor{red}{[Luiz]: #1}}
...
\titulo{New perspectives into analyzing biological collections data based on a social network analytics framework}
% Nome do aluno
...
\begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   \assinatura{\textbf{Prof. Charles Darwin, a naturalist}}
